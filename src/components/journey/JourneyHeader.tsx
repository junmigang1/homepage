          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="relative flex-shrink-0">
                ...
                />
                <Badge className="absolute -top-2 -right-2 bg-accent text-accent-foreground text-sm px-3 py-1">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  ...
                  <p className="text-lg font-semibold">
                    {bookData.currentOwner}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {bookData.currentOwnerSchool}
                  </p>
                  <div className="flex items-center gap-1 mt-1">
                    <MapPin className="h-4 w-4 text-muted-foreground" />
                    <span className="text-sm text-muted-foreground">
                      {bookData.currentLocation}
                    </span>
                  </div>
                </div>
                ...
                {bookData.nextReader && (
                  <div className="bg-accent/10 rounded-lg p-4 border border-accent/20">
                    ...
                    <p className="font-semibold">
                      {bookData.nextReader}님에게 전달 예정
                    </p>
                    <p className="text-sm text-muted-foreground">
                      {bookData.nextReaderSchool}
                    </p>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  {bookData.isExchangeable && <Button>교환 요청하기</Button>}
                </div>
              </div>
            </div>
          </CardContent>
