...
const myComments = [
  {
    ...
    type: 'review',
    content:
      '이 책을 읽고 나서 인류의 역사를 완전히 다르게 보게 되었어요. 특히 농업혁명 부분이 정말 충격적이었습니다. 우리가 당연하게 여기는 것들이 사실은 얼마나 최근의 발명인지...',
    rating: 5,
  ...
  },
  {
    ...
    type: 'journey_note',
    content:
      '빅브라더가 당신을 지켜보고 있다... 이 한 줄이 얼마나 무서운지 이제야 알겠어요. 현실과 너무 닮아있어서 소름이 돋았습니다. 다음 독자분께서도 좋은 시간 되시길!',
  ...
  },
  {
    ...
    type: 'review',
    content:
      '감정을 느끼지 못하는 소년의 이야기인데, 오히려 더 깊은 감동을 받았어요. 우리가 당연하게 여기는 감정들이 얼마나 소중한지, 그리고 그 감정들을 나눌 수 있는 사람들이 얼마나 중요한지...',
    rating: 5,
  ...
  },
  {
    ...
    type: 'tip',
    content:
      '이 책에서 배운 공부법을 실제로 적용해봤는데 정말 효과가 있었어요! 특히 25분 집중 + 5분 휴식 사이클이 정말 도움이 됐습니다. 여러분도 한번 시도해보세요!',
  ...
  },
  {
    ...
    book: {
      ...
      author: '엠제이 드마코',
      coverUrl:
        'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=60&h=90&fit=crop',
    },
    type: 'review',
    content:
      '부를 창출하는 새로운 사고방식을 제시하는 책이네요. 기존의 직장인 사고방식에서 벗어나야 한다는 메시지가 인상적이었습니다.',
    rating: 4,
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {
                          commentTypeLabels[
                            comment.type as keyof typeof commentTypeLabels
                          ]
                        }
                      </Badge>
                      {!comment.isPublic && (
